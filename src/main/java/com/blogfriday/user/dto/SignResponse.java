...
public class SignResponse {
    ...
    public SignResponse(String user_idemail, String user_password, String user_name, String user_phonenumber, String user_nickname, String user_profile, String user_code, String user_id) {
        super();
        this.user_idemail = user_idemail;
        this.user_password = user_password;
